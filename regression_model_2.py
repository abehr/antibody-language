...
train_data = EmbeddingGenerator(name, seqs[:500], foldx_dict, batch_size)
valid_data = EmbeddingGenerator(name, seqs[500:700], foldx_dict, batch_size)
test_data = EmbeddingGenerator(name, seqs[700:900], foldx_dict, batch_size)
...
print('Save model to file %s' % model_fp)
model.save(model_fp)
